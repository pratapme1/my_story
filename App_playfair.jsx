...
const CSS = `
@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;0,800;0,900;1,700;1,800&family=Inter:wght@300;400;500;600&family=JetBrains+Mono:wght@400;500&display=swap');
        ...
        {stages.map((s, i) => (
          <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", width: `${100 / stages.length}%` }}>
            ...
            <div style={{ textAlign: "center", opacity: step >= i ? 1 : .3, transition: "opacity .5s ease" }}>
              <div style={{ fontFamily: "'Playfair Display',serif", fontSize: "12px", fontWeight: 700, color: T.white, marginBottom: 4 }}>{s.label}</div>
      ...
      <div style={{ position: "relative", zIndex: 2, textAlign: "center", maxWidth: 680, padding: "0 48px", display: "flex", flexDirection: "column", gap: 20 }}>
        {lines.map((l, i) => (
          <div key={i} style={{
            ...
            <span style={{ fontFamily: "'Playfair Display',serif", fontSize: l.size, fontWeight: l.bold ? 800 : 400, color: l.color || T.white, letterSpacing: "-0.02em", lineHeight: 1.1 }}>
              {l.text}
            </span>
          </div>
        ))}
    ...
    <div className="scene" style={{ background: T.white, cursor: "pointer" }} onClick={onNext}>
      ...
      {phase < 2 && (
        <div style={{ textAlign: "center", zIndex: 2, animation: "fadeIn .4s ease" }}>
          ...
          <div style={{
            fontFamily: "'Playfair Display',serif", fontSize: "clamp(14px,1.8vw,22px)",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20, marginBottom: 36 }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontFamily: "'Playfair Display',serif", fontSize: "15px", fontWeight: 700, color: T.navy, marginBottom: 6 }}>{w.label}</div>
          ...
          {phase >= 3 && (
            <div style={{ display: "flex", gap: 40, animation: "fadeUp .5s ease .1s both" }}>
              {[
                ...
                <div key={i}>
                  <div style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(22px,2.8vw,36px)", fontWeight: 800, color: m.color, letterSpacing: "-0.02em", lineHeight: 1 }}>{m.val}</div>
    ...
    <div className="scene" style={{ background: T.navy, cursor: "pointer" }} onClick={onNext}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1000, padding: "0 60px", width: "100%" }}>
        ...
        <div className="fu2" style={{ marginBottom: 40 }}>
          <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(28px,3.5vw,54px)", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-0.025em", color: T.white }}>
            First of its kind.{" "}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 20, opacity: showMetrics ? 1 : 0, transition: "opacity .6s ease" }}>
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ fontFamily: "'Playfair Display',serif", fontSize: "28px", fontWeight: 800, color: m.color, letterSpacing: "-0.02em", lineHeight: 1 }}>{m.val}</div>
    ...
    <div className="scene" style={{ background: T.white, overflowY: "auto", alignItems: "flex-start" }}>
      <div style={{ width: "100%", maxWidth: 1040, padding: "64px 64px 80px", margin: "0 auto" }}>
        ...
        <div className="fu2" style={{ marginBottom:28 }}>
          <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(24px,3vw,46px)", fontWeight:800, lineHeight:1.1, letterSpacing:"-0.02em", color:T.navy }}>
        ...
        <div className="fu3" style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:12, marginBottom:20 }}>
          {[
            ...
            <div key={i} style={{ background:T.white, border:`1.5px solid ${T.line}`, borderRadius:12, padding:"16px 18px", textAlign:"center" }}>
              <div style={{ fontFamily:"'Playfair Display',serif", fontSize:"38px", fontWeight:800, color:s.color, lineHeight:1, letterSpacing:"-0.02em" }}>{s.val}</div>
              <div style={{ fontFamily:"'Playfair Display',serif", fontSize:"11px", fontWeight:700, color:T.navy, marginTop:4 }}>{s.label}</div>
